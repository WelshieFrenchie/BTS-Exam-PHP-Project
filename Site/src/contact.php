...
<html>
    ...
    <div class="container mt-5">
        ...
        <h4 class="text-center text-danger mb-4">Ceci est un projet personnel. Ainsi, le formulaire n'est là pour le projet et aucune requête serait pris en compte</h4>
        <div class="row">
